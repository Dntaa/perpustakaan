...
<body class="bg-gray-100 text-gray-800">
  ...
  <header class="bg-indigo-700 text-white flex items-center justify-between px-4 py-3 md:hidden">
    ...
    <button id="menuToggle" aria-label="Toggle menu" class="focus:outline-none">
  ...
  <div class="flex min-h-screen">
    <!-- Sidebar -->
    <aside id="sidebar"
      class="fixed inset-y-0 left-0 z-50 w-64 bg-indigo-700 text-white p-6 transform -translate-x-full transition-transform duration-200 ease-in-out md:relative md:translate-x-0 md:flex md:flex-col">
      ...
      <footer class="mt-10 text-xs text-indigo-200 text-center">&copy; 2025 SiPus - Praktikum</footer>
    </aside>
